...
import qualified TestBlock2.Task2 (test)
import qualified TestBlock3.Task1 (test)
import qualified TestBlock3.Task2 (test)
...
main = do
  ...
  testBlock2Task2 <- TestBlock2.Task2.test
  defaultMain $ testGroup "Blok2" [testBlock2Task1, testBlock2Task2]
  
  testBlock3Task1 <- TestBlock3.Task1.test
  testBlock3Task2 <- TestBlock3.Task2.test
  defaultMain $ testGroup "Block3" [testBlock3Task1, testBlock3Task2]
